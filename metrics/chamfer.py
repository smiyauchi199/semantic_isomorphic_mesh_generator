...
class ChamferDistance(torch.nn.Module):
    ...
    def forward(
        ...
        if bidirectional:
            ...
            return chamfer_forward, chamfer_backward, idx1, idx2
        if reverse:
...
def knn_points(
    ...
    return _KNN(dists=p1_dists, idx=p1_idx, knn=p2_nn if return_nn else None), p1_idx
