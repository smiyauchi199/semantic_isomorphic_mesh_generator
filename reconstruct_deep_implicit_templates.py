...
def reconstruct(
    ...
    latent = torch.load(os.path.join("examples/cars_dit/LatentCodes/template.pth"))
    latent = Variable(latent[0]).cuda()
...
if __name__ == "__main__":
    ...
    # npz_filenames = ["template_smg.npz"]
    ...
    for ii, npz in enumerate(npz_filenames):
        ...
        # full_filename = os.path.join(args.experiment_directory, "TrainingMeshes/2000", npz)
